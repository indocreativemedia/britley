...
/**
 * Add extra CSS classes to the "Read More" link generated by <!--more--> tag.
 *
 * Hook: the_content_more_link
 *
 * @param string $link The HTML anchor tag for the more link.
 * @param string $text The link text.
 * @return string Modified HTML with extra classes.
 */
add_filter( 'the_content_more_link', function( $link, $text ) {
	return str_replace(
		'class="more-link"',
		'class="more-link btn btn-outline-primary my-1"',
		$link
	);
}, 10, 2 );
